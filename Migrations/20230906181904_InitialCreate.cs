...
namespace CreekRiverAPI.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "jjjingleheimerschmit@email.com", "John", "Jingleheimerschmit" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 3, 3, "https://example.com/image3.jpg", "Mountain View Hideaway" },
                    { 4, 4, "https://example.com/image4.jpg", "Squirrel Haven" },
                    { 5, 1, "https://example.com/image5.jpg", "Lakefront Serenity" },
                    { 6, 2, "https://example.com/image6.jpg", "Sunset Paradise" }
                });

            migrationBuilder.InsertData(
                table: "Reservations",
                columns: new[] { "Id", "CampsiteId", "CheckinDate", "CheckoutDate", "UserProfileId" },
                values: new object[] { 1, 2, new DateTime(2023, 9, 6, 13, 19, 4, 248, DateTimeKind.Local).AddTicks(6684), new DateTime(2023, 9, 6, 0, 0, 0, 0, DateTimeKind.Local), 1 });
